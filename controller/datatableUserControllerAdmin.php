...
$columns = array(
  ...
  array('db' => 'image', 'dt' => 4, 'formatter'=> function($d,$row){
    $image = ($d == "user.png") ? "../../assets/img/user.png": "../images/" . $d;
    return '<img class="rounded-circle" src="'.$image.'" style="width: 100px;" alt="" />';
  }),
  // array( 'db' => 'office', 'dt' => 3 ),
  array('db' => 'id', 'dt' => 5,    'formatter' => function ($d, $row) {
    ob_start();
    include('../public/component/admin/modalUpdateUser.php');
    $modal = ob_get_clean();
    return
      '<div class="btn-group">    
        <button data-bs-toggle="modal"
          data-bs-target="#modalUpdateUser' . $row[0] . '" type="button" class="btn btn-warning">
